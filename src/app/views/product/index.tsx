        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font tracking-widest uppercase">{singleProduct?.brand}</h2>
              ...
              <div className="flex mb-4">
                <span className="flex items-center">
                  ...
                  <span className="text-gray-600 ml-3">{`${singleProduct?.rating} ${t("lbl.rating")}`}</span>
                </span>
              </div>
              ...
              <div className="flex">
                ...
                <button className="flex ml-auto text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded" onClick={() => singleProduct && dispatch(addToCart(singleProduct))}>{t("lbl.add")}</button>
